...
def all_bandpowers(data):
   return [
      bandpower(data, 250, [1, 4], 10, True),
      bandpower(data, 250, [4, 8], 10, True),
      bandpower(data, 250, [8, 12], 10, True),
      bandpower(data, 250, [12, 30], 10, True),
      bandpower(data, 250, [30, 100], 10, True)     
   ]
